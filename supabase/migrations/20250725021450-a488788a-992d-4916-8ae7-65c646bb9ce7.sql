...
-- Create a new fee configuration for post-graduation
INSERT INTO public.fee_config (
  ...
  50,   -- 0.5% platform (post-graduation)
  100,  -- 1% creator (post-graduation)
  30,   -- 0.3% prize pool (same)
  20    -- 0.2% reserves (same)
);
