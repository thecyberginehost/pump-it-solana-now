-- Remove conflicting achievement that already exists
DELETE FROM public.achievement_types WHERE name = 'Diamond Hands' AND category = 'milestone';

-- Add buyer/trader achievement types (avoiding duplicates)
